...
import 'package:user_studify/user_schedule/user_table.dart';
import 'package:user_studify/user_schedule/user_whereAreWe.dart';
...
class _UserScheduleState extends State<UserSchedule> {
  ...
  CollectionReference firebaseInstance = FirebaseFirestore.instance.collection('communication').doc('23').collection('weeks');
              ...
              children: [
                FutureBuilder<List<DocumentSnapshot>>(
                    future: Future.wait([
                      ...
                      firebaseInstance.doc('${weekIndex}').get()
                    ]),
                                                  ...
                                                  children: [
                                                    ...
                                                    SizedBox(
                                                      ...
                                                      child: DropdownButton(
                                                        ...
                                                        onChanged: (newvalue) {
                                                          Hive.box('settings').put('weekIndex', newvalue.toString())   ;
                                                          setState(() {});
                                                        },
                                                      ),
                                                    ),
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      Expanded(child: IconButton(icon: Icon(Icons.notes), onPressed: (){
